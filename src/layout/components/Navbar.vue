  ...
  <div class="navbar">
    ...
    <div class="flex">
      ...
      <div v-if="device !== 'mobile'" class="setting-container">
        <!--全屏 -->
        <div class="setting-item" @click="toggle" style="margin-right: 10px;">
          <svg-icon
        ...
        <!-- 布局大小 -->
        <el-tooltip content="布局大小" effect="dark" placement="bottom" style="margin-right: 10px;">
      ...
      <el-dropdown trigger="click" style="margin-right: 38px;">
        <div class="avatar-container" >
          <!-- 后端存储头像地址   ?imageView2/1/w/80/h/80 是网络地址加载图片时,对图片压缩及像素处理 -->
